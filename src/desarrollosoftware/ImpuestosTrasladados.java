...
public class ImpuestosTrasladados extends javax.swing.JFrame {
    DefaultTableModel modelo;
    ConsultaSQL consulta = new ConsultaSQL();
    ConexionSQL conexion = new ConexionSQL();
    Connection cn = conexion.getConnection();
    
    public ImpuestosTrasladados() {
        initComponents();
        
        this.setTitle("Impuestos Trasladados");
    ...
    public void obtenerRegistros() {
        String sql = "select * from concepto where tipoImpuesto = 'Traslado'";
  ...
  public void ingresarRegistros(ArrayList<Concepto> lista) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImpuestosTrasladados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ImpuestosTrasladados().setVisible(true);
            }
        });
    }
